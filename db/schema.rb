...
ActiveRecord::Schema.define(version: 20150927154331) do
  ...
  create_table "rating_associations", force: :cascade do |t|
    t.integer  "rating_id"
    t.integer  "topic_id"
    t.integer  "post_id"
  ...
  add_index "rating_associations", ["post_id"], name: "index_rating_associations_on_post_id"
  add_index "rating_associations", ["rateable_type", "rateable_id"], name: "index_rating_associations_on_rateable_type_and_rateable_id"
  add_index "rating_associations", ["rating_id"], name: "index_rating_associations_on_rating_id"
